...
mod tests {
  ...
  fn can_read_student_account() {
    let data = fs::read_to_string("tests/student_login.json")
  ...
  fn can_read_student_primary_account() {
    let data = fs::read_to_string("tests/studentp_login.json")
      .expect("failed to read json file");
  ...
  fn can_read_family_account() {
    let data = fs::read_to_string("tests/family_login.json")
      .expect("failed to read json file");
